...
def level_2():
	...
	enemy.atk = E_ATK = 35
	enemy.dfc = E_DFC = 12
	enemy.crh = E_CRH = 0.02
	enemy.cre = E_CRE = 1.6
	enemy.rhp = E_RHP = 0.1
	enemy.thp = E_THP = 0.02
	enemy.fhp = E_FHP = 0
	enemy.mis = E_MIS = 0
...
def level_3():
	...
	enemy.atk = E_ATK = 50
	enemy.dfc = E_DFC = 18
	enemy.crh = E_CRH = 0.05
	enemy.cre = E_CRE = 2
	enemy.rhp = E_RHP = 0.5
	enemy.thp = E_THP = 0.04
	enemy.fhp = E_FHP = 0
	enemy.mis = E_MIS = 0.01
...
def level_4():
	...
	enemy.cre = E_CRE = 2
	enemy.rhp = E_RHP = 1
	enemy.thp = E_THP = 0.05
	enemy.fhp = E_FHP = 0.3
	enemy.mis = E_MIS = 0.02
...
def level_5():
	...
	enemy.atk = E_ATK = 70
	enemy.dfc = E_DFC = 20
	enemy.crh = E_CRH = 0.15
	enemy.cre = E_CRE = 2.3
	enemy.rhp = E_RHP = 1.5
	enemy.thp = E_THP = 0.08
	enemy.fhp = E_FHP = 0.2
	enemy.mis = E_MIS = 0.05
...
print("国王交代给你一些事情: ")
sleep(interval)
print("1.角色的能量上限为 3，用以使用技能。")
sleep(interval)
print("2.关卡一共 10 关，每关的怪物都有几率掉落宝石，可以大幅增加属性，关卡数越高，几率越大")
sleep(interval)
...
while lead.hp > 0:
	...
	if lead.hp > 0 and level_list[10] == True:
		...
		if egg == "liujunyi0729":
			...
			sleep(interval)
			print("后续会增加天赋系统和武器系统还有更多的关卡，敬请期待! ")
			sleep(interval)
